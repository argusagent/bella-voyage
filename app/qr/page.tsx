    ...
    <main className="min-h-screen bg-paper px-6 py-14 sm:px-10 sm:py-20 print:bg-white print:py-0">
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        >
          ...
          />
          <figcaption className="mt-5 font-mono text-[10px] uppercase tracking-widest3 text-ink/65 sm:text-[11px] print:text-[10px]">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3 print:hidden">
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full border border-ink/85 bg-ink px-5 py-2.5 font-mono text-[10px] uppercase tracking-widest2 text-paper transition-all hover:border-gold focus-visible:border-gold sm:px-6 sm:py-3 sm:text-[11px]"
          >
        ...
        <div className="mt-10 max-w-md font-sans text-sm leading-relaxed text-ink/65 print:hidden">
          ...
          <p className="mt-3 font-mono text-[10px] uppercase tracking-widest3 text-ink/45">
